        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="absolute top-[50%] -right-8 bg-white/90 backdrop-blur-sm p-4 rounded-lg shadow-lg w-1/2 sm:max-w-xs">
              ...
              <div className="absolute top-[50%] -right-8 bg-white/90 backdrop-blur-sm p-4 rounded-lg shadow-lg w-1/2 sm:max-w-xs" style={{ transform: 'translateY(80px)' }}>
                <p className="text-sm text-gray-700 mb-3">
